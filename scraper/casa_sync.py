"""
HouseRadar — Casa.it Sync
==========================
Scraping Casa.it + push a Render via POST /api/sync.

Strategia DB:
  - Su GitHub Actions (GITHUB_ACTIONS=true): /tmp/houseradar_casa.db
  - In locale: backend/propagnent.db se esiste, altrimenti /tmp
...
_TMP_DB   = "/tmp/houseradar_casa.db"
