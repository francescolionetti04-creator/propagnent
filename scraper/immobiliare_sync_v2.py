"""
HouseRadar — Immobiliare.it Sync v2 (Playwright)
=================================================
Scraping Immobiliare.it via Playwright + push a Render via POST /api/sync.

Richiede `playwright` installato e Chromium già scaricato:
...
_TMP_DB   = "/tmp/houseradar_imm_v2.db"
...
def main():
    ...
    try:
        n = immobiliare_scraper_v2.scrapa_immobiliare_v2()
    ...
    try:
        ...
        print(f"[Sync] ✓ {len(annunci)} annunci → Render | "
