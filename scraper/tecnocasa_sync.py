"""
HouseRadar — Tecnocasa.it Sync
===============================
Scraping Tecnocasa.it + push a Render via POST /api/sync.
"""
...
import tecnocasa_scraper
tecnocasa_scraper.DB_PATH = DB_PATH
...
def main():
    ...
    try:
        n = tecnocasa_scraper.scrapa_tecnocasa()
